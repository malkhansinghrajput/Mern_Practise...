...
import { BrowserRouter as Router, Link, Route, Routes, NavLink, useNavigate, useLocation, useParams } from 'react-router-dom'
...
const About = () => {
    ...
    const handleContact = () => {
        navigate("/contact", { state: { name: "Neha Sharma", age: 23, address: "Indore M.P" } })
    }
    return (
        <div>
