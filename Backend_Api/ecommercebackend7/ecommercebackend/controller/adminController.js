...
class AdminController {
    ...
    static editproduct = async (req, res) => {
        const { product_id } = req.query
        console.log(product_id)
        // const { product_brand, product_variant_name, product_description, product_mrp, product_sp, product_discount, product_size,
        //     product_color, product_quantity, product_availability } = req.body
        console.log(req.body)
